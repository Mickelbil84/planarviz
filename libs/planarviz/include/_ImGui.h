/*
*  All right are reserved to Dear ImGui of course.
*  This is copied so that apps using planarviz can only find and link against planarviz
*  (As imgui is compiled statically into libplanarviz).
*/
